...
#define STRING_CONFIG_H_AUTHOR "Herr Papi" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Printertje"
...
#define SKEW_CORRECTION
  ...
  #define XY_DIAG_AC 140.65
  #define XY_DIAG_BD 141.85
  #define XY_SIDE_AD 99.95
